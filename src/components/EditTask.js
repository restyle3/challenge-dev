...
export function EditTask() {
  ...
  return (
    <Form onSubmit={onSubmit}>
      ...
      <FormGroup>
        <Label>Tarefa</Label>
        <Input type="text" defaultValue={selectedTask.name} onChange={onChange} required />
      </FormGroup>
      <FormGroup>
      ...
      <FormGroup>
        ...
        <textarea type="text" className="form-control" defaultValue={selectedTask.desc} onChange={onChangeDesc} required />
      </FormGroup>
      ...
      <Link to="/" className="btn btn-sm btn-outline-danger me-2">
